...
class TabletForgotPassword extends ConsumerStatefulWidget {
  const TabletForgotPassword({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _TabletForgotPassword();
}

class _TabletForgotPassword extends ConsumerState<TabletForgotPassword> {
  // isAuthenticating
