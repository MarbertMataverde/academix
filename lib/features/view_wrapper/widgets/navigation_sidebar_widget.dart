...
import 'package:academix/features/bulletin/view/bulletin_view.dart';
...
List<Widget> listOfContents = const [
  BulletinView(),
  Expanded(
    child: Center(
...
Widget buildSidebar({required BuildContext context, required WidgetRef ref}) {
...
Color getSidebarBorderColor(String themeState) {
