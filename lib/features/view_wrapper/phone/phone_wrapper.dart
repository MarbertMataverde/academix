...
// PhoneWrapper renders the sidebar navigation and main content
/// for the desktop UI.
class PhoneWrapper extends ConsumerStatefulWidget {
  const PhoneWrapper({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _PhoneWrapperState();
}

class _PhoneWrapperState extends ConsumerState<PhoneWrapper> {
  @override
